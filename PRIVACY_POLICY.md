...
在上传过程中，应用会自动裁剪图像，仅提取头发区域（如发际线与头顶 ROI 区域），不包含完整面部信息。
...
- 智谱 AI：[https://open.bigmodel.cn/dev/howuse/policy](https://open.bigmodel.cn/dev/howuse/policy)
